...
(function (model) {
    describe("ResultSchema", function () {
        ...
        it("should have a schema for every category", function () {
            model.Categories.ALL.forEach(function (category) {
                var factory = new model.ResultFactory("Horst", category);
                new model.ResultSchemaValidator(factory.create());
            });
        });
        it("should always contain it's specified category", function () {
            var factory = new model.ResultFactory("Horst", model.Categories.A10_20);
            factory.child(model.Categories.A10_1).add();
            factory.child(model.Categories.A10_1).add();
        ...
        it("should check results recursively", function () {
            var factory = new model.ResultFactory("Horst", model.Categories.A10_20);
            var invalidFactory = factory.child(model.Categories.A10_10);
            invalidFactory.child(model.Categories.A10_10).add();
            invalidFactory.add();
            checkInvalid(factory.create(), "The results contains nested results which are invalid, but they were not detected");
        });
        describe(model.Categories.A10_1, function () {
            resultWithNoChildrenTestSuite(model.Categories.A10_1, 10);
        });
        describe(model.Categories.A10_10, function () {
            combinedResultTestSuite(model.Categories.A10_10, model.Categories.A10_1, 10, 100);
        });
        describe(model.Categories.A10_20, function () {
            combinedResultTestSuite(model.Categories.A10_20, model.Categories.A10_10, 2, 200);
        });
        describe(model.Categories.A10_30, function () {
            combinedResultTestSuite(model.Categories.A10_30, model.Categories.A10_10, 3, 300);
        });
        describe(model.Categories.A10_40, function () {
            combinedResultTestSuite(model.Categories.A10_40, model.Categories.A10_10, 4, 400);
        });
        describe(model.Categories.A10_60, function () {
            combinedResultTestSuite(model.Categories.A10_60, model.Categories.A10_10, 6, 600);
        });
        describe(model.Categories.A30_K_1, function () {
            resultWithNoChildrenTestSuite(model.Categories.A30_K_1, 10);
        });
        describe(model.Categories.A30_K_10, function () {
            combinedResultTestSuite(model.Categories.A30_K_10, model.Categories.A30_K_1, 10, 100);
        });
        describe(model.Categories.A30_K_20, function () {
            combinedResultTestSuite(model.Categories.A30_K_20, model.Categories.A30_K_10, 2, 200);
        });
        describe(model.Categories.A30_K_30, function () {
            combinedResultTestSuite(model.Categories.A30_K_30, model.Categories.A30_K_10, 3, 300);
        });
        describe(model.Categories.A30_S_1, function () {
            resultWithNoChildrenTestSuite(model.Categories.A30_S_1, 10);
        });
        describe(model.Categories.A30_S_10, function () {
            combinedResultTestSuite(model.Categories.A30_S_10, model.Categories.A30_S_1, 10, 100);
        });
        describe(model.Categories.A30_S_20, function () {
            combinedResultTestSuite(model.Categories.A30_S_20, model.Categories.A30_S_10, 2, 200);
        });
        describe(model.Categories.A30_S_30, function () {
            combinedResultTestSuite(model.Categories.A30_S_30, model.Categories.A30_S_10, 3, 300);
        });
    });
